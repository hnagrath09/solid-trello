...
func (o *Task) List(mods ...qm.QueryMod) listQuery {
...
func (taskL) LoadList(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
...
// SetList of the task to the related item.
// Sets o.R.List to related.
// Adds o to related.R.Tasks.
func (o *Task) SetList(ctx context.Context, exec boil.ContextExecutor, insert bool, related *List) error {
	var err error
	if insert {
